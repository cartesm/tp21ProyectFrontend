export default {
    ...
    paper: {
        name: "Papel",
        obtention: "Se puede obtener de papeles de oficina, periódicos, revistas, cartón, etc. Se puede separar del resto de residuos y depositar en el contenedor azul.",
        utility: "El papel reciclado se puede utilizar para fabricar nuevos productos de papel, como papel higiénico, cuadernos, cajas, etc.",
        images: [
    ...
    cardboard: {
        "name": "Cartón",
        "obtention": "Se puede obtener de cajas, envases, etc. Se puede separar del resto de residuos y depositar en el contenedor azul.",
        "utility": "El cartón reciclado se puede utilizar para fabricar nuevos productos de cartón, como cajas, embalajes, etc.",
        images: [
    ...
    glass: {
        name: "Vidrio",
        obtention: "En el hogar, los residuos de vidrio se pueden obtener de botellas, frascos, tarros, vasos, etc. Estos residuos se pueden depositar en contenedores de reciclaje específicos para vidrio.",
        utility: " En el hogar, los residuos de vidrio se pueden reutilizar de muchas maneras. Una forma popular es fabricar jarrones, macetas, vasos, etc. Esto se puede hacer de forma sencilla, utilizando herramientas básicas como una sierra, un taladro y un horno. Para fabricar un jarrón, por ejemplo, se pueden cortar las botellas de vidrio en trozos de la forma deseada. Luego, se pueden unir los trozos con pegamento o silicona. Para darle un acabado más elegante, se puede pintar o decorar el jarrón.",
        images: [
